    ...
    <x-auth-card>
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input-error :messages="$errors->get('name')" class="mt-2 text-blue-500 dark:text-blue-300" />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2 text-blue-500 dark:text-blue-300" />
            </div>
