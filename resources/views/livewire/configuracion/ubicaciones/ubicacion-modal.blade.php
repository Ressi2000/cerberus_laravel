            ...
            <div class="relative z-50 w-full max-w-lg mx-4 bg-white dark:bg-cerberus-mid
                ...
                <div class="px-6 py-5 space-y-4">
                    ...
                    <x-form.input
                        label="Nombre"
                        wire:model="nombre"
                        placeholder="Ej: Sede Caracas, Oficina Maracaibo..."
                    ...
                    <div class="rounded-lg border {{ $es_estado
                            ? 'border-purple-200 dark:border-purple-500/40 bg-purple-50 dark:bg-purple-500/10'
                            : 'border-gray-200 dark:border-cerberus-steel/50 bg-gray-50 dark:bg-cerberus-dark/50'
                        }} p-4">
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-800 dark:text-white flex items-center gap-1.5">
                                    <span class="material-icons text-base {{ $es_estado ? 'text-purple-500' : 'text-gray-400' }}">
                                        public
                                    </span>
                                    Ubicación foránea
                                </p>
                                <p class="text-xs mt-1 {{ $es_estado ? 'text-purple-600 dark:text-purple-300' : 'text-gray-500 dark:text-cerberus-light' }}">
                                    @if ($es_estado)
                            ...
                            <button wire:click="$set('es_estado', {{ $es_estado ? 'false' : 'true' }})"
                                type="button"
