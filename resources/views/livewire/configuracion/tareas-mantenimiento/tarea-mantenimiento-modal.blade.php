            ...
            <div class="relative z-50 w-full max-w-md mx-4 bg-white dark:bg-cerberus-mid
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-cerberus-steel">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                        <span class="material-icons text-cerberus-accent">{{ $tareaId ? 'edit' : 'checklist' }}</span>
                        {{ $tareaId ? 'Editar tarea' : 'Nueva tarea del catálogo' }}
                    </h2>
                ...
                <div class="px-6 py-5 space-y-4">
                    <x-form.input
                        ...
                        wire:model="nombre"
                        placeholder="Ej: Revisión/cambio de pasta térmica"
                    ...
                    <x-form.input
                        ...
                        type="number"
                        wire:model="orden"
                        hint="Define el orden en que aparece dentro de la checklist."
                        :error="$errors->first('orden')"
                    />
                </div>
