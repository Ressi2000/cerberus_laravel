            ...
            <div class="relative z-50 w-full max-w-sm mx-4 bg-white dark:bg-cerberus-mid
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-cerberus-steel">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                        <span class="material-icons text-cerberus-accent">badge</span>
                        Detalle del tipo de licencia
                    </h2>
                ...
                <div class="px-6 py-5 space-y-4">
                    <div>
                        ...
                        <p class="text-base font-semibold text-gray-900 dark:text-white mt-0.5">{{ $tipoLicencia->nombre }}</p>
                    </div>
                    <div>
                        <p class="text-xs font-medium text-gray-500 dark:text-cerberus-accent uppercase tracking-wide">Usuarios con esta licencia</p>
                        <p class="text-3xl font-bold text-gray-900 dark:text-white mt-0.5">{{ $tipoLicencia->usuarios_count }}</p>
                    </div>
                </div>

                <div class="flex justify-end gap-3 px-6 py-4 border-t border-gray-100 dark:border-cerberus-steel">
                    <button wire:click="$dispatch('openLicenciaMicrosoftEditar', { id: {{ $tipoLicencia->id }} }); close()"
