            ...
            <div class="relative z-50 w-full max-w-md mx-4 bg-white dark:bg-cerberus-mid
                ...
                <div class="flex items-center justify-between px-6 py-4
                    ...
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                        <span class="material-icons text-cerberus-accent">domain</span>
                        Detalle de empresa
                    </h2>
                ...
                <div class="px-6 py-5 space-y-4">
                    ...
                    @if ($empresa->rif)
                        <div>
                            ...
                            <p class="text-sm font-mono text-gray-800 dark:text-white mt-0.5">
                                {{ $empresa->rif }}
                            </p>
                        </div>
                    @endif
                    ...
                    {{-- Conteos de recursos vinculados --}}
                    <div class="grid grid-cols-3 gap-3 pt-2 border-t border-gray-100 dark:border-cerberus-steel">
                ...
                <div class="flex justify-end gap-3 px-6 py-4
                    ...
                    <button wire:click="$dispatch('openEmpresaEditar', { id: {{ $empresa->id }} }); close()"
