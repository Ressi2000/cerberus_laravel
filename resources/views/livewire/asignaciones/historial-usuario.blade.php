...
<div class="space-y-6">
    ...
    <div
        ...
        <div class="flex items-start justify-between gap-4 flex-wrap">
            ...
            {{-- Planilla de egreso --}}
            <a href="{{ route('admin.asignaciones.planilla.egreso', $this->usuario) }}" target="_blank"
    ...
    <section>
        <div class="flex items-center justify-between gap-3 mb-4 flex-wrap">
            ...
            <div class="flex items-center gap-2 flex-wrap">
                ...
                {{-- Filtro estado --}}
                <div
                    class="flex rounded-lg border border-gray-200 dark:border-cerberus-steel/50 overflow-hidden text-xs">
            ...
            <div class="relative">
                ...
                <div class="space-y-4">
                    @foreach ($this->asignaciones as $asignacion)
                        ...
                        --}}
                        <div wire:key="hist-{{ $asignacion->id }}" x-data="{ open: {{ $asignacion->estado === 'Activa' ? 'true' : 'false' }} }" class="relative flex gap-4">

                            {{-- Dot del timeline --}}
                            <div
                                class="relative z-10 flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full
                            ...
                            <div
                                class="flex-1 min-w-0 bg-white dark:bg-cerberus-mid
                                        border border-gray-200 dark:border-cerberus-steel
                                        ...
                                        <div
                                            ...
                                            <div class="min-w-0">
                                                <p
                                                    ...
                                                    @if ($esPeriférico)
                                                        <span
                                                            class="text-xs text-cerberus-primary/50 dark:text-cerberus-accent/50">
                                                            (periférico)
                                                        </span>
                                                    @endif
                                                </p>
