<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="bg-cerberus-mid border border-cerberus-steel shadow-cerberus rounded-xl p-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                <span class="material-icons text-cerberus-accent text-2xl">edit</span>
                <div>
                    <h2 class="text-xl font-bold text-white">Editar equipo</h2>
                    <p class="text-cerberus-light text-sm">
                        Código: <span class="text-white font-mono">{{ $equipo->codigo_interno }}</span>
                    </p>
                </div>
            </div>
            {{-- Badge categoría (solo lectura) --}}
            <span class="px-3 py-1 text-xs rounded-full bg-cerberus-primary/20 border border-cerberus-primary/40
                         text-cerberus-accent font-medium">
    ...
    <div class="bg-cerberus-mid border border-cerberus-steel shadow-cerberus rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            {{-- Categoría (solo lectura, no se puede cambiar) --}}
            <div class="md:col-span-2">
                <label class="block text-cerberus-accent text-sm mb-1">Categoría</label>
                <div class="w-full bg-cerberus-darkest border border-cerberus-steel/50 text-cerberus-light
                            rounded-lg px-4 py-2 flex items-center gap-2 cursor-not-allowed">
                    <span class="material-icons text-cerberus-steel text-sm">lock</span>
                    {{ $equipo->categoria->nombre }}
                    <span class="ml-auto text-xs text-cerberus-steel italic">No modificable</span>
                </div>
            </div>
    ...
    @if(count($atributos) > 0)
        <div class="bg-cerberus-mid border border-cerberus-steel shadow-cerberus rounded-xl p-6">
            ...
            <p class="text-cerberus-light text-xs mb-5 ml-7">
                Los cambios en estos campos generan un nuevo registro en el historial del equipo.
            </p>
    ...
    {{-- ALERTA: historial de cambios --}}
    <div class="bg-cerberus-primary/10 border border-cerberus-primary/30 rounded-xl px-5 py-3
                flex items-start gap-3">
        <span class="material-icons text-cerberus-accent text-lg mt-0.5">history</span>
        <p class="text-cerberus-light text-sm">
            Cualquier cambio en las características técnicas quedará registrado en el
            <strong class="text-white">historial del equipo</strong> con fecha y usuario responsable.
        </p>
    </div>
